...
skills: research-operations, simple-english
---
...
withholds. `simple-english` binds it. Read that skill's checklist against the
finished text before you report.

## Writing

`simple-english` governs the prose: short sentences, active voice, simple
tenses, one word one meaning, condition before command, a term defined at
first use. Sentence case headings. Serial commas. No idioms. No directional
language as orientation. Tables introduced in the text before they appear.
